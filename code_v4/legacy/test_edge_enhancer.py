...
class EdgeEnhancerInference:
    ...
    def __init__(self, model_path, device='auto'):
        ...
        if device == 'auto':
            if torch.cuda.is_available():
                ...
                print("[EdgeEnhancer] Using CUDA")
            elif hasattr(torch.backends, 'mps') and torch.backends.mps.is_available():
                self.device = torch.device('mps')
                print("[EdgeEnhancer] Using MPS")
            else:
                self.device = torch.device('cpu')
                print("[EdgeEnhancer] Using CPU")
        else:
        ...
        print("[EdgeEnhancer] Model loaded OK")
    ...
    def load_model(self, model_path):
        ...
        print(f"[EdgeEnhancer] Loaded: {os.path.basename(model_path)}")
